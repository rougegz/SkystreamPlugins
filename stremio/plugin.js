(function () {
  ...
  function detectSize(s, t) {
    ...
    var m = t.match(/(\d+(?:\.\d+)?)\s*(GB|GiB|MB|MiB)/i);
    return m ? m[0].replace("MiB", "MB").replace("GiB", "GB") : null;
  }
